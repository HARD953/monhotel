  ...
  return(
    <div className="w-100 p-0 mx-0">
      <Button 
        ...
        <div className="mx-auto py-2 InputSearcBar_btn_container">
...
export default  function RechercheInputs() {
      ...
      <section className="mt-5 accueil-search">
        <div className="container-lg" >
          <div  
            ...
            <InputSearcBar 
              onClickFn={(e)=>refVille?.current?.toggle(e)}
              value={!!location ? location.name : "Abidjan"}
              label="Ville" />
            <InputSearcBar 
            ...
            <div className='px-4'>
              <Button onClick={(e)=>refVille?.current?.toggle(e)} icon="pi pi-search" rounded text  />
            </div>
          </div>
        </div>
